...
export const NOTIFICATION_PUSH = {
  payment: {
    new: {
      title: NOTIFICATION_PUSH_TEXT.PAYMENT.NEW.TITLE,
      body: NOTIFICATION_PUSH_TEXT.PAYMENT.NEW.BODY
    },
    accepted: {
      title: NOTIFICATION_PUSH_TEXT.PAYMENT.ACCEPTED.TITLE,
      body: NOTIFICATION_PUSH_TEXT.PAYMENT.ACCEPTED.BODY
    },
    declined: {
  ...
  profile: {
    email: {
      updated: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.EMAIL.UPDATED.TITLE,
    ...
    phone: {
      updated: {
        ...
        body: NOTIFICATION_PUSH_TEXT.PROFILE.PHONE.UPDATED.BODY
      }
    },
    address: {
      added: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.ADDED.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.ADDED.BODY
      },
      updated: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.UPDATED.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.UPDATED.BODY
      },
      default: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.DEFAULT.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.ADDRESS.DEFAULT.BODY
      }
    },
    pin: {
      enabled: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.ENABLED.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.ENABLED.BODY
      },
      disabled: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.DISABLED.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.DISABLED.BODY
      },
      updated: {
        title: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.UPDATED.TITLE,
        body: NOTIFICATION_PUSH_TEXT.PROFILE.PIN.UPDATED.BODY
      }
    }
  },
  device: {
    verified: {
      title: NOTIFICATION_PUSH_TEXT.DEVICE.VERIFIED.TITLE,
      body: NOTIFICATION_PUSH_TEXT.DEVICE.VERIFIED.BODY
    }
  }
}
